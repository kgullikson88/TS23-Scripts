...
if __name__ == "__main__":
    ...
    for fname in fileList:
        ...
        for vsini in [10, 20, 30, 40]:
            Correlate.PyCorr(data, combine=False, resolution=60000,
                             outdir="Cross_correlations/%s" % (fname.split(".fits")[0]), models=model_list,
                             stars=star_list, temps=temp_list, gravities=gravity_list, metallicities=metal_list,
                             vsini=vsini * Units.cm / Units.km, pause=10)
