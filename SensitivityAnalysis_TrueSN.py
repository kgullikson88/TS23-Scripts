...
def Add(data, model, prim_spt, sec_spt, age="MS", vel=0.0, SN_order=19, sensitivity=lambda x: 1.0,
...
if __name__ == "__main__":
    ...
    logfile.write(
        "Parent SpT\tS/N Ratio\tSecondary SpT\tParent Mass\tSecondary Mass\tMass Ratio\tPercent Detected\tAverage Significance\n")
    ...
    for s_spt in sec_spts[s_left:s_right]:
        ...
        for datafile in datafiles:
            ...
            for segment in good_sections[SN_order]:
                ...
                snr += numpy.std(
                    orders_original[SN_order].y[left:right] / orders_original[SN_order].cont[left:right]) ** 2
            ...
            for p_spt in parent_spts[p_left:p_right]:
                ...
                for velocity in velocitylist:
                    ...
                    vel, corr = Correlate.PyCorr(orders, models=[[x, y], ], segments=good_sections, save_output=False,
                                                 vsini=15 * Units.cm / Units.km, resolution=60000)
